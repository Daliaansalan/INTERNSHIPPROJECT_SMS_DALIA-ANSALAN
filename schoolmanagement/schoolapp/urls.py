...
urlpatterns = [
    ...
    path('adminclick',views.adminclick_view,name='adminclick_view'),
    path('teacherclick',views.teacherclick_view,name='teacherclick_view'),
    path('studentclick',views.studentclick_view,name='studentclick_view'),


    path('adminsignup', views.admin_signup_view,name='admin_signup_view'),
    path('studentsignup', views.student_signup_view,name='studentsignup'),
    path('teachersignup', views.teacher_signup_view,name='teacher_signup_view'),
